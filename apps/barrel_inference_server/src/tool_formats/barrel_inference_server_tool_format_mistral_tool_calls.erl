...
family_name() -> <<"mistral-tool-calls">>.

%% Generic Mistral v3 JSON-array shape. Templates that ALSO carry
%% `[ARGS]' after `[TOOL_CALLS]' detect as `mistral-args' (the
%% tekken-tokenizer fine-tunes); this family is the fall-through.
-spec detect(binary()) ->
